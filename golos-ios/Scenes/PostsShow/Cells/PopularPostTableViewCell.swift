//
//  PopularPostTableViewCell.swift
//  Golos
//
...
class PopularPostTableViewCell: UITableViewCell, HandlersCellSupport {
    ...
    override var reuseIdentifier: String? {
        return PopularPostTableViewCell.reuseIdentifier
    }
...
extension PopularPostTableViewCell: ConfigureCell {
    func setup(withItem item: Any?, andIndexPath indexPath: IndexPath) {
        guard let popular = item as? Popular else {
            return
        }
        
        // Get user info
        if let user = User.fetch(byName: popular.author) {
        ...
        if let coverImageURL = popular.coverImageURL, !coverImageURL.isEmpty {
