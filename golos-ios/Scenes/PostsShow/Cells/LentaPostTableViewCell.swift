...
class LentaPostTableViewCell: UITableViewCell, HandlersCellSupport {
    // MARK: - Properties
    ...
    override var reuseIdentifier: String? {
        return LentaPostTableViewCell.reuseIdentifier
    }
...
extension LentaPostTableViewCell: ConfigureCell {
    func setup(withItem item: Any?, andIndexPath indexPath: IndexPath) {
        ...
        if let coverImageURL = lenta.coverImageURL, !coverImageURL.isEmpty {
